...
<pre><code class="lang-cpp">std::vector&lt;int&gt; map = &lbrace;
    1, 2, 1, 2, 1, 2,
    2, 0, 0, 0, 0, 1,
    1, 0, 3, 0, 0, 2,
    2, 0, 0, 0, 0, 1,
...
<pre><code class="lang-cpp">// width is the screen width
int lines = width;
...
<pre><code class="lang-cpp">void Player::TakePerspective(std::vector&lt;float&gt;* distances, std::vector&lt;int&gt;* hits, std::vector&lt;float&gt;* uTexCoords, std::vector&lt;int&gt;* map, const float* scl, const int* mapWidth, const int* mapHeight) &lbrace;
