...
class="sourceCode cpp"><code class="sourceCode cpp"><span id="cb1-1"><span class="bu">std::</span>vector<span class="op">&lt;</span><span class="dt">int</span><span class="op">&gt;</span> map <span class="op">=</span> <span class="op">{"{"}</span></span>
<span id="cb1-2">    <span class="dv">1</span><span class="op">,</span> <span class="dv">2</span><span class="op">,</span> <span class="dv">1</span><span class="op">,</span> <span class="dv">2</span><span class="op">,</span> <span class="dv">1</span><span class="op">,</span> <span class="dv">2</span><span class="op">,</span></span>
<span id="cb1-3">    <span class="dv">2</span><span class="op">,</span> <span class="dv">0</span><span class="op">,</span> <span class="dv">0</span><span class="op">,</span> <span class="dv">0</span><span class="op">,</span> <span class="dv">0</span><span class="op">,</span> <span class="dv">1</span><span class="op">,</span></span>
<span id="cb1-4">    <span class="dv">1</span><span class="op">,</span> <span class="dv">0</span><span class="op">,</span> <span class="dv">3</span><span class="op">,</span> <span class="dv">0</span><span class="op">,</span> <span class="dv">0</span><span class="op">,</span> <span class="dv">2</span><span class="op">,</span></span>
<span id="cb1-5">    <span class="dv">2</span><span class="op">,</span> <span class="dv">0</span><span class="op">,</span> <span class="dv">0</span><span class="op">,</span> <span class="dv">0</span><span class="op">,</span> <span class="dv">0</span><span class="op">,</span> <span class="dv">1</span><span class="op">,</span></span>
<span id="cb1-6">    <span class="dv">1</span><span class="op">,</span> <span class="dv">0</span><span class="op">,</span> <span class="dv">0</span><span class="op">,</span> <span class="dv">0</span><span class="op">,</span> <span class="dv">0</span><span class="op">,</span> <span class="dv">2</span><span class="op">,</span></span>
<span id="cb1-7">    <span class="dv">2</span><span class="op">,</span> <span class="dv">1</span><span class="op">,</span> <span class="dv">2</span><span class="op">,</span> <span class="dv">1</span><span class="op">,</span> <span class="dv">2</span><span class="op">,</span> <span class="dv">1</span></span>
<span id="cb1-8"><span class="op">};</span></span></code></pre></div>
<p>First comes the intial calls to cast rays and as well as collect
their distances and a few other bits of data.</p>
<div class="sourceCode" id="cb2"><pre
class="sourceCode cpp"><code class="sourceCode cpp"><span id="cb2-1"><span class="co">// width is the screen width</span></span>
...
<span id="cb3-2">    <span class="cf">for</span><span class="op">(</span><span class="dt">int</span> i <span class="op">=</span> <span class="dv">0</span><span class="op">;</span> i <span class="op">&lt;</span> distances<span class="op">-&gt;</span>size<span class="op">();</span> i<span class="op">++)</span> <span class="op">{"{"}</span></span>
<span id="cb3-3">        distances<span class="op">-&gt;</span>at<span class="op">(</span>i<span class="op">)</span> <span class="op">=</span> RayCast<span class="op">(</span></span>
<span id="cb3-4">            hits<span class="op">-&gt;</span>at<span class="op">(</span>i<span class="op">),</span> uTexCoords<span class="op">-&gt;</span>at<span class="op">(</span>i<span class="op">),</span></span>
<span id="cb3-5">            map<span class="op">,</span> scl<span class="op">,</span> mapWidth<span class="op">,</span> mapHeight<span class="op">,</span></span>
<span id="cb3-6">            <span class="co">// Angle each ray will travel at relative to the player&#39;s angle</span></span>
<span id="cb3-7">            lerp<span class="op">(</span>PI <span class="op">*</span> <span class="fl">0.25</span><span class="op">,</span> PI <span class="op">*</span> <span class="op">-</span><span class="fl">0.25</span><span class="op">,</span> <span class="op">(</span><span class="dt">float</span><span class="op">)</span> i <span class="op">/</span> <span class="op">(</span><span class="dt">float</span><span class="op">)</span> distances<span class="op">-&gt;</span>size<span class="op">()));</span></span>
<span id="cb3-8">    <span class="op">}</span></span>
<span id="cb3-9"><span class="op">}</span></span></code></pre></div>
