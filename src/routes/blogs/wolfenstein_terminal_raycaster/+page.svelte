<h1 id="wolfenstein-terminal-raycaster">Wolfenstein Terminal
Raycaster</h1>
<p>So after watching a video by the youtube <a
href="https://www.youtube.com/watch?v=fSjc8vLMg8c">jdh</a> I was
...
curses, or in my case <a
href="https://tldp.org/HOWTO/NCURSES-Programming-HOWTO/">ncurses</a>, to
...
actual code present to a minimum.</p>
<p><em>Also I like lists to its gonna be a list &lt;3</em></p>
<h2 id="introduction">Introduction</h2>
<p>Wolfenstein 3D was a revolutionary game that was one of the first
...
actually the first step, 3D came <em>much</em> later.</p>
<p>Put simply, 2D raycasting follows these simple steps: 1. Cast a ray
...
distance = longer screen line</p>
<p><em>Thats it.</em> This was oversimplified to not include some
...
raycaster like Wolfenstein 3D works.</p>
<h2 id="first-steps">First Steps</h2>
<p>Again, no platform spesifics, just the math, but first I initialize
...
is the real prize.</p>
<p>Here is the map I will be working with. Anything that is not a zero
is a wall, the number of each wall comes in later for texturing.</p>
<div class="sourceCode" id="cb1"><pre
class="sourceCode cpp"><code class="sourceCode cpp"><span id="cb1-1"><a href="#cb1-1" aria-hidden="true" tabindex="-1"></a><span class="bu">std::</span>vector<span class="op">&lt;</span><span class="dt">int</span><span class="op">&gt;</span> map <span class="op">=</span> <span class="op">{"{"}</span></span>
<span id="cb1-2"><a href="#cb1-2" aria-hidden="true" tabindex="-1"></a>    <span class="dv">1</span><span class="op">,</span> <span class="dv">2</span><span class="op">,</span> <span class="dv">1</span><span class="op">,</span> <span class="dv">2</span><span class="op">,</span> <span class="dv">1</span><span class="op">,</span> <span class="dv">2</span><span class="op">,</span></span>
<span id="cb1-3"><a href="#cb1-3" aria-hidden="true" tabindex="-1"></a>    <span class="dv">2</span><span class="op">,</span> <span class="dv">0</span><span class="op">,</span> <span class="dv">0</span><span class="op">,</span> <span class="dv">0</span><span class="op">,</span> <span class="dv">0</span><span class="op">,</span> <span class="dv">1</span><span class="op">,</span></span>
<span id="cb1-4"><a href="#cb1-4" aria-hidden="true" tabindex="-1"></a>    <span class="dv">1</span><span class="op">,</span> <span class="dv">0</span><span class="op">,</span> <span class="dv">3</span><span class="op">,</span> <span class="dv">0</span><span class="op">,</span> <span class="dv">0</span><span class="op">,</span> <span class="dv">2</span><span class="op">,</span></span>
<span id="cb1-5"><a href="#cb1-5" aria-hidden="true" tabindex="-1"></a>    <span class="dv">2</span><span class="op">,</span> <span class="dv">0</span><span class="op">,</span> <span class="dv">0</span><span class="op">,</span> <span class="dv">0</span><span class="op">,</span> <span class="dv">0</span><span class="op">,</span> <span class="dv">1</span><span class="op">,</span></span>
<span id="cb1-6"><a href="#cb1-6" aria-hidden="true" tabindex="-1"></a>    <span class="dv">1</span><span class="op">,</span> <span class="dv">0</span><span class="op">,</span> <span class="dv">0</span><span class="op">,</span> <span class="dv">0</span><span class="op">,</span> <span class="dv">0</span><span class="op">,</span> <span class="dv">2</span><span class="op">,</span></span>
<span id="cb1-7"><a href="#cb1-7" aria-hidden="true" tabindex="-1"></a>    <span class="dv">2</span><span class="op">,</span> <span class="dv">1</span><span class="op">,</span> <span class="dv">2</span><span class="op">,</span> <span class="dv">1</span><span class="op">,</span> <span class="dv">2</span><span class="op">,</span> <span class="dv">1</span></span>
<span id="cb1-8"><a href="#cb1-8" aria-hidden="true" tabindex="-1"></a><span class="op">};</span></span></code></pre></div>
<p>First comes the intial calls to cast rays and as well as collect
their distances and a few other bits of data.</p>
<div class="sourceCode" id="cb2"><pre
class="sourceCode cpp"><code class="sourceCode cpp"><span id="cb2-1"><a href="#cb2-1" aria-hidden="true" tabindex="-1"></a><span class="co">// width is the screen width</span></span>
...
<code>map</code>, <code>mapWidth</code>, and <code>mapHeight</code>.</p>
<div class="sourceCode" id="cb3"><pre
class="sourceCode cpp"><code class="sourceCode cpp"><span id="cb3-1"><a href="#cb3-1" aria-hidden="true" tabindex="-1"></a><span class="dt">void</span> Player<span class="op">::</span>TakePerspective<span class="op">(</span><span class="bu">std::</span>vector<span class="op">&lt;</span><span class="dt">float</span><span class="op">&gt;*</span> distances<span class="op">,</span> <span class="bu">std::</span>vector<span class="op">&lt;</span><span class="dt">int</span><span class="op">&gt;*</span> hits<span class="op">,</span> <span class="bu">std::</span>vector<span class="op">&lt;</span><span class="dt">float</span><span class="op">&gt;*</span> uTexCoords<span class="op">,</span> <span class="bu">std::</span>vector<span class="op">&lt;</span><span class="dt">int</span><span class="op">&gt;*</span> map<span class="op">,</span> <span class="at">const</span> <span class="dt">float</span><span class="op">*</span> scl<span class="op">,</span> <span class="at">const</span> <span class="dt">int</span><span class="op">*</span> mapWidth<span class="op">,</span> <span class="at">const</span> <span class="dt">int</span><span class="op">*</span> mapHeight<span class="op">)</span> <span class="op">{"{"}</span></span>
<span id="cb3-2"><a href="#cb3-2" aria-hidden="true" tabindex="-1"></a>    <span class="cf">for</span><span class="op">(</span><span class="dt">int</span> i <span class="op">=</span> <span class="dv">0</span><span class="op">;</span> i <span class="op">&lt;</span> distances<span class="op">-&gt;</span>size<span class="op">();</span> i<span class="op">++)</span> <span class="op">{"{"}</span></span>
<span id="cb3-3"><a href="#cb3-3" aria-hidden="true" tabindex="-1"></a>        distances<span class="op">-&gt;</span>at<span class="op">(</span>i<span class="op">)</span> <span class="op">=</span> RayCast<span class="op">(</span></span>
<span id="cb3-4"><a href="#cb3-4" aria-hidden="true" tabindex="-1"></a>            hits<span class="op">-&gt;</span>at<span class="op">(</span>i<span class="op">),</span> uTexCoords<span class="op">-&gt;</span>at<span class="op">(</span>i<span class="op">),</span></span>
<span id="cb3-5"><a href="#cb3-5" aria-hidden="true" tabindex="-1"></a>            map<span class="op">,</span> scl<span class="op">,</span> mapWidth<span class="op">,</span> mapHeight<span class="op">,</span></span>
<span id="cb3-6"><a href="#cb3-6" aria-hidden="true" tabindex="-1"></a>            <span class="co">// Angle each ray will travel at relative to the player&#39;s angle</span></span>
<span id="cb3-7"><a href="#cb3-7" aria-hidden="true" tabindex="-1"></a>            lerp<span class="op">(</span>PI <span class="op">*</span> <span class="fl">0.25</span><span class="op">,</span> PI <span class="op">*</span> <span class="op">-</span><span class="fl">0.25</span><span class="op">,</span> <span class="op">(</span><span class="dt">float</span><span class="op">)</span> i <span class="op">/</span> <span class="op">(</span><span class="dt">float</span><span class="op">)</span> distances<span class="op">-&gt;</span>size<span class="op">()));</span></span>
<span id="cb3-8"><a href="#cb3-8" aria-hidden="true" tabindex="-1"></a>    <span class="op">}</span></span>
<span id="cb3-9"><a href="#cb3-9" aria-hidden="true" tabindex="-1"></a><span class="op">}</span></span></code></pre></div>
<h2 id="about-raycasting">About Raycasting</h2>
<p>The actual raycasting is the true meat of this program. There were
...
to the more complex algorithm which I used in the C++ version.</p>
<p>The method I used is performant because of its lack of taxing
...
between their map space and world space counterparts.</p>
<p>Because player position is held in world space we need a way to get
...
get it’s slope with <code>float m = -std::tan(rayAngle)</code>.</p>
<p>Now the actual raycasting happens in two parts, and this is because
...
the ray we will return to be our overall collided ray.</p>
<p>In addition to the distance the ray has traveled, we also want to
...
<p>From here the process is pretty straight forward. We now have a list
...
other services. The GitHub repo can be found <a
href="https://github.com/EggbertFluffle/RaycastRenderer.git">here</a>.
Happy coding!</p>
