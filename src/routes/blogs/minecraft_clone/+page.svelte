...
<ol>
<li>I want to be able to render blocks of different textures with culled faces (more on that later)</li>
<li>Those blocks should be generated using Perlin Noise and held in chunks</li>
<li>There should be free cam controls using the wasd and arrow key/mouse controls</li>
<li>Blocks should be removable and placable by the player relative to where they look</li>
<li>The entire project should be organized, from the make files, to the encapsulation of classes</li>
</ol>
...
<pre><code class="lang-cpp"><span class="hljs-comment">// Block.hpp</span>
...
<pre><code class="lang-cpp">void GameManager::cullFaces(int x, int y, int z) &lbrace;
        ...
        Block* dirs[<span class="hljs-number">6</span>] = &lbrace;
        ...
        <span class="hljs-keyword">for</span>(int i = <span class="hljs-number">0</span>; i &lt; <span class="hljs-number">6</span>; i++) &lbrace;
                unsigned char f = <span class="hljs-number">0b10000000</span> &gt;&gt; (i);
                Block* b = dirs[i];
                <span class="hljs-keyword">if</span> (b == nullptr || (b != nullptr &amp;&amp; b-&gt;id != <span class="hljs-number">0</span>)) &lbrace;
                        faces = faces | f;
                &rbrace;
        &rbrace;
        faces = ~faces;
...
<pre><code class="lang-cpp">void Player::castBlockRay(GameManager* gameManager) &lbrace;
        ...
        <span class="hljs-keyword">for</span>(<span class="hljs-built_in">float</span> a = <span class="hljs-number">0</span>; a &lt; <span class="hljs-number">1.</span><span class="hljs-number">0f</span>; a += <span class="hljs-number">0.</span><span class="hljs-number">01f</span>) &lbrace;
                // the actual lerping
                glm::vec3 reach(
                ...
                <span class="hljs-keyword">if</span>(<span class="hljs-built_in">block</span> != nullptr &amp;&amp; <span class="hljs-built_in">block</span>-&gt;id != <span class="hljs-number">0</span>) &lbrace;
