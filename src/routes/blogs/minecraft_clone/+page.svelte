...
<pre><code class="lang-c++">void GameManager::cullFaces(int x, int y, int z) &lbrace;
...
<pre><code class="lang-c++">void Player::castBlockRay(GameManager* gameManager) &lbrace;
