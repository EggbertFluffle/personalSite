<h1 id="linux-on-a-laptop-my-experience-pt.-2">Linux on a Laptop: My
Experience (pt. 2)</h1>
<p>Hello again! If you’re here from Part 1, great! I’m glad you’re
...
laptop-specifics. For example, I want to talk about <a
href="https://suckless.org/dwm">dwm</a>, my window manager of choice,
...
obstacles I came across while putting together my system.</p>
<p>One program that I should mention before everything else is
...
it opens the door to making system configuration so fast and simple.</p>
<h2 id="dwm-and-company">DWM and Company</h2>
<p><a href="https://suckless.org/dwm">dwm</a> is a dynamic tiling window
...
switch tags, and launch dmenu, if installed. <a
href="https://suckless.org/dmenu">dmenu</a> is an <em>essential</em>,
...
opinion, patches.</p>
<p>Patches are just file diffs provided by the Suckless team and
...
your changes, it’s pretty easy to keep your configs safe.</p>
<p>As for specifics on other programs, I mentioned slstatus which is a
...
good conversation starter.</p>
<figure>
<img src="/images/dwm_status_bar.png"
alt="dwm status bar with Minecraft font" />
<figcaption aria-hidden="true">dwm status bar with Minecraft
font</figcaption>
</figure>
<p>In my bar, I was also able to design a module that will tell me if I
...
hex values in the config and downloading a quick patch.</p>
<h2 id="gods-grace-vim-neovim">God’s Grace, Vim (Neovim)</h2>
<p>I would be amiss to not mention the tools I use, especially <a
href="https://neovim.io/">Neovim</a>. Now I want to try as hard as
...
right.</p>
<p>But what I also didn’t realize is just the sheer power behind Vim
...
to fall in love with what I find and art form.</p>
<p>In any case, Neovim is a big part of the build and had to be
mentioned. I followed the <a
href="https://www.youtube.com/c/theprimeagen">Primeagens</a> build of
Neovim using packer as my package manager for plugins before migrating
my config to be built on Folke’s <a
href="https://github.com/folke/lazy.nvim">lazy.nvim</a>. Another program
...
use, here is a little preview and a link to my config on GitHub <a
href="https://github.com/EggbertFluffle/nvim">here</a>:</p>
<ul>
<li><a
href="https://github.com/ellisonleao/gruvbox.nvim">gruvbox.nvim</a> - I
need to say no more.</li>
<li><a
href="https://github.com/nvim-telescope/telescope.nvim">telescope.nvim</a>
- Essential for navigating projects. Allows for fuzzy finding files
names and their contents.</li>
<li><a
href="https://github.com/nvim-treesitter/nvim-treesitter">nvim-treesitter</a>
- Syntax highlighting made easy</li>
<li><a
href="https://github.com/altermo/ultimate-autopair.nvim">ultimate-autopair.nvim</a>
...
- Comment lines or blocks of code regardless of language.</li>
<li><a href="https://github.com/lsp-zero.nvim">lsp-zero.nvim</a> - How
does anyone program without LSP and completions?</li>
<li><a href="https://github.com/stevearc/oil.nvim">oil.nvim</a> - File
tree/navigator (NETRW is good too, imo)</li>
</ul>
<p>Obviously, on top of this, there are some small quality of life
...
<h2 id="linux-tools-system-configuration">Linux Tools &amp; System
Configuration</h2>
<p>I intended to daily drive Void Linux on my new ThinkPad T16 as I
...
installed.</p>
<p>I spent litteral days trying to fix this issue by editing Python
...
is a terrible option as an operating system daily driver.</p>
<p>I don’t have enough experience with the average Linux desktop
...
stick with Void and DWM for now.</p>
<p>I just wanna yap about my rice a little more, and I’ll leave some
...
left alt as my mod key. Here are the binds:</p>
<ul>
<li>Mod+Enter -&gt; opens Alacritty</li>
<li>Mod+P -&gt; open dmenu for launching apps</li>
<li>Mod+Shift+C -&gt; close focused window</li>
<li>Mod+Shift+I -&gt; open my internet browser (Firefox)</li>
<li>Mod+Shift+Y -&gt; open YouTube (in Firefox)</li>
<li>Mod+Shift+D -&gt; open discord (in Firefox)</li>
<li>Mod+Shift+M -&gt; open my school email (in Firefox)</li>
<li>Mod+Shift+T -&gt; open Spotify (in Firefox)</li>
<li>Mod+Shift+G -&gt; open my GitHub profile (in Firefox)</li>
<li>Mod+Shift+W -&gt; open an iwgtk, a frontend for iwd (network
controls).</li>
<li>Mod+Shift+S -&gt; Take a screenshot with scrot</li>
<li>Mod+Shift+Z -&gt; Launch <a
href="https://github.com/tsoding/boomer">boomer</a>, very cool app for
zooming</li>
<li>Mod+Shift+B -&gt; opens Bluetooth in Alacrity, a Bluetooth
connection manager.</li>
<li>Mod+Shift+P -&gt; opens btop in Alacritty, a process viewer</li>
</ul>
<p>This isn’t all the key-binds. For example, I had to bind my volume
...
<p>But with this territory comes the slight annoyance of not being able
...
to.</p>
<p><img src="/images/general_void_dwm_desktop.png" /> <img
src="/images/coding_pokemon_void_desktop.png" /></p>
