...
<div id="whoAmI" style="--foreground: {$currentTheme.foreground}; --red: {$currentTheme.red}; --green: {$currentTheme.green}; --background2: {$currentTheme.background2}; --yellow: {$currentTheme.yellow}; --orange: {$currentTheme.orange};">
	...
	<ul>
		...
		<li><a target="_blank" href="https://github.com/EggbertFluffle/kitty"><strong>Kitty</strong></a> - Just a terminal emulator, I like it for the in built image rendering. It also has nice paneling that can be similar to my dwm binds but I don't take advantage of those often.</li>
